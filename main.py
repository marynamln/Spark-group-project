...
from title_basics_df_filtering import filter_different_titles, filter_drama_movies, filter_movies_after_2010
...
if __name__ == '__main__':
    ...
    df_movies_after_2010 = filter_movies_after_2010(df_title_basics)
    write_title_basics_df_to_csv(df_movies_after_2010, output_path="data/results/df_movies_after_2010.csv",
                                 mode="overwrite")
