...
from name_df_cleaning_and_transformation import convert_columns_to_snake_case, convert_death_year_to_int
...
if __name__ == '__main__':
    ...
    transformed_dy_col_df.show(50)

    transformed_dy_col_df.printSchema()
